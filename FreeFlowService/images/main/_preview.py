...
Usage:
    cd apps/freeflow/main/FreeFlowService/images/main
...
ROUTES = {
    ...
    "/invite/abc123": (
        "invite.html",
        {
            ...
            "admin_user": None,
            "connect_url": "freeflow://connect?url=http://127.0.0.1:5555&token=abc123",
        },
    ),
    "/invite/admin": (
        "invite.html",
        {
            ...
            "is_admin_token": True,
            "admin_user": None,
            "connect_url": "freeflow://connect?url=http://127.0.0.1:5555&token=admin",
        },
    ),
    "/invite/invalid": (
        "invite.html",
