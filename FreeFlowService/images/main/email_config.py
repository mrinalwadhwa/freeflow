...
async def send_test_email(to_address: str) -> str:
    ...
    subject = "FreeFlow email configuration test"
    text = "This is a test email from your FreeFlow service. If you received this, email sending is working correctly."
    html = (
        "<p>This is a test email from your FreeFlow service.</p>"
