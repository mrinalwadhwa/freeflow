...
* All commits must be [signed](https://docs.github.com/en/authentication/managing-commit-signature-verification/signing-commits) and verified by GitHub.
* All authors must abide by the [Code of Conduct](CODE_OF_CONDUCT.md).
* We follow a linear commit history. Rebase to the base branch; no merge commits.
* Commit messages: imperative mood, verb-first, under 50 characters.
