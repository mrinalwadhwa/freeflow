...
///
/// Calls `GET /api/auth/capabilities` on the FreeFlowService zone and
...
public final class CapabilitiesService: @unchecked Sendable {
    ...
    private static let cacheKey = "computer.autonomy.freeflow.capabilities"
    ...
    ///
    /// - Parameter serviceURL: Base URL of the FreeFlowService zone.
