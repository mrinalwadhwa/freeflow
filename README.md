...
On first launch, FreeFlow walks you through setup: create an Autonomy account, deploy your server, and start dictating. About two minutes to your first dictation.
